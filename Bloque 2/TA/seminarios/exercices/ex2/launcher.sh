...
export SCRIPTS_ROOTDIR=$MOSES/scripts
export PATH=$PATH:$SCRIPTS_ROORDIR/training/
export PATH=$PATH:/home/miguel/Documentos/TA/srilm/bin/i686-m64
export PATH=$PATH:$MOSES/bin/
...
cd train
ngram-count -order 3 -unk -interpolate -kndiscount -text training.clean.en -lm model.lm
