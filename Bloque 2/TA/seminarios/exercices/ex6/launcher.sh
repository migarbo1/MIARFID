...
$SCRIPTS_ROOTDIR/training/train-model.perl -root-dir work -mgiza -mgiza-cpus 1 -corpus training.clean -f es -e en -alignment grow-diag-final-and -reordering monotonicity-bidirectional-fe -lm 0:3:$LangModel -external-bin-dir $GIZA> training.out
