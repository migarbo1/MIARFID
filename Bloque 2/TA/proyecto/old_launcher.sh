...
if [[ $SMOOTHER == "interpolate" ]]
then
	$SMOOTHER="-interpolate"
else
	$SMOOTHER=""
fi

#clean corpus
clean-corpus-n.perl ${CORPUS_PATH}/europarl-v7.es-en-train-red es en ${CORPUS_PATH}/europarl-v7.es-en-train-red.clean 1 60
...
${TRAIN_SCRIPTS}clean-corpus-n.perl ${CORPUS_PATH}/europarl-v7.es-en-dev-red es en ${CORPUS_PATH}/europarl-v7.es-en-dev-red.clean 1 60
...
#translation process
$MOSES/bin/moses \
-f mert-work/moses.ini < ${CORPUS_PATH}/europarl-v7.es-en-test.es > test.hyp

echo "translation performed"

#evaluation
$MOSES/scripts/generic/multi-bleu.perl -lc ${CORPUS_PATH}/europarl-v7.es-en-test.en < test.hyp > res_n${NGRAM}_i${MAX_ITER}_${SMOOTHER}_${DISCOUNT}_${ALIGNMENT}.txt
