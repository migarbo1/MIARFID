...
#clean corpus
clean-corpus-n.perl ${CORPUS_PATH}/europarl-v7.es-en-train-red-tok en es ${CORPUS_PATH}/europarl-v7.es-en-train-red.clean 1 60
...
ngram-count -order $NGRAM -unk -interpolate -${DISCOUNT} -text ${CORPUS_PATH}/europarl-v7.es-en-train-red.clean.es -lm ${LangModel} 

echo $LangModel
echo "output language model trained!"

#train translation model
${TRAIN_SCRIPTS}train-model.perl -root-dir work -mgiza -mgiza-cpus 1 -corpus ${CORPUS_PATH}/europarl-v7.es-en-train-red.clean -f en -e es -alignment ${ALIGNMENT} -reordering msd-bidirectional-fe -lm 0:$NGRAM:$LangModel -external-bin-dir $GIZA> ${CORPUS_PATH}/europarl-v7.es-en-train-red.out
echo "translation model trained!"

# train log-linear model weights
${TRAIN_SCRIPTS}clean-corpus-n.perl ${CORPUS_PATH}/europarl-v7.es-en-dev-red-tok en es ${CORPUS_PATH}/europarl-v7.es-en-dev-red.clean 1 60
echo "development corpus cleaned"

${TRAINING_SCRIPTS}mert-moses.pl \
${CORPUS_PATH}/europarl-v7.es-en-dev-red.clean.en ${CORPUS_PATH}/europarl-v7.es-en-dev-red.clean.es \
...
#translation process
$MOSES/bin/moses \
-f mert-work/moses.ini < ${CORPUS_PATH}/europarl-v7.es-en-test-tok.en > test.hyp

echo "translation performed"

#evaluation
$MOSES/scripts/generic/multi-bleu.perl -lc ${CORPUS_PATH}/europarl-v7.es-en-test-tok.es < test.hyp > res_n${NGRAM}_i${MAX_ITER}_${SMOOTHER}_${DISCOUNT}_${ALIGNMENT}.txt
